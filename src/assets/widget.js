const getHtml = (trans) => {
    return `
        ...
        <div class="rs-box rs-box-initial" aria-hidden="false">
            <h3 class="rs-small-headline">${trans.connectYourStorage}</h3>
            <span class="rs-sub-headline">${trans.toSyncDataWithYourAccount}</span>
        </div>
        ...
        <div class="rs-box rs-box-connected" aria-hidden="true">
            ...
            <span class="rs-sub-headline">${trans.connected}</span>
            </div>
            <div class="rs-connected-buttons">
            <button class="rs-button rs-button-small rs-sync" title="${trans.syncNow}">
            ...
            <button class="rs-button rs-button-small rs-disconnect" title="${trans.disconnect}">
        ...
        <div class="rs-box rs-box-error" aria-hidden="true">
            ...
            <a href="#" class="rs-reconnect rs-hidden">${trans.renew}</a>
            <button class="rs-button rs-button-small rs-disconnect" title="${trans.disconnect}">
                <svg class="rs-icon rs-power-icon" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="16" height="16"
                style="enable-background:new 0 0 512 512" xml:space="preserve"
                viewBox="0 0 512 512" version="1.1">
        ...
        <div class="rs-box rs-box-choose" aria-hidden="true">
            ...
            <h1 class="rs-big-headline">${trans.connectStorageTitle}</h1>
            <p class="rs-short-desc">
                ${trans.connectStorageParagraph}
            </p>
        ...
        <div class="rs-box rs-box-sign-in" aria-hidden="true">
            ...
            <form name="rs-sign-in-form" class="rs-sign-in-form">
                ...
                <button type="submit" class="rs-connect">${trans.connect}</button>
                <a href="https://remotestorage.io/get/" class="rs-help" target="_blank" rel="noopener">${trans.needHelp}</a>
            </form>
            </div>
        </div>
        </div>
